      ...
      >
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            ...
            <div
              class="mt-3 text-center w-full pr-0 sm:mt-0 sm:ml-4 sm:pr-14 sm:text-left"
            >
              <h3
                id="modal-title"
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button
            type="button"
            class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-primaryAccent text-base font-medium text-white hover:bg-primaryAccentDark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primaryAccent sm:ml-3 sm:w-auto sm:text-sm"
